...
public class GuiClass {
	...
	public void setupHistograms() {
		...
		for (int ibin = 0; ibin < Parray.size() - 1; ibin++) {
			...
			h1_vsDistanceAllREC_vsP
					.add(new H1F("h1_vsDistanceAllREC_" + ibin, "h1_vsDistanceAllREC_" + Parray.get(ibin) + "_" + Parray.get(ibin + 1), 400, 0., 400.));
			h1_vsDistanceQPREC_vsP
					.add(new H1F("h1_vsDistanceQPREC_" + ibin, "h1_vsDistanceQPREC_" + Parray.get(ibin) + "_" + Parray.get(ibin + 1), 400, 0., 400.));
			h1_vsDistanceQMREC_vsP
					.add(new H1F("h1_vsDistanceQMREC_" + ibin, "h1_vsDistanceQMREC_" + Parray.get(ibin) + "_" + Parray.get(ibin + 1), 400, 0., 400.));

			h1_vsDistanceAllTRIGGER_vsP
					.add(new H1F("h1_vsDistanceAllTRIGGER_" + ibin, "h1_vsDistanceAllTRIGGER_" + Parray.get(ibin) + "_" + Parray.get(ibin + 1), 400, 0., 400.));
			h1_vsDistanceQPTRIGGER_vsP
					.add(new H1F("h1_vsDistanceQPTRIGGER_" + ibin, "h1_vsDistanceQPTRIGGER_" + Parray.get(ibin) + "_" + Parray.get(ibin + 1), 400, 0., 400.));
			h1_vsDistanceQMTRIGGER_vsP
					.add(new H1F("h1_vsDistanceQMTRIGGER_" + ibin, "h1_vsDistanceQMTRIGGER_" + Parray.get(ibin) + "_" + Parray.get(ibin + 1), 400, 0., 400.));

			h1_vsDistanceAllTRIGGER2_vsP.add(
					new H1F("h1_vsDistanceAllTRIGGER2_" + ibin, "h1_vsDistanceAllTRIGGER2_" + Parray.get(ibin) + "_" + Parray.get(ibin + 1), 400, 0., 400.));
			h1_vsDistanceQPTRIGGER2_vsP
					.add(new H1F("h1_vsDistanceQPTRIGGER2_" + ibin, "h1_vsDistanceQPTRIGGER2_" + Parray.get(ibin) + "_" + Parray.get(ibin + 1), 400, 0., 400.));
			h1_vsDistanceQMTRIGGER2_vsP
					.add(new H1F("h1_vsDistanceQMTRIGGER2_" + ibin, "h1_vsDistanceQMTRIGGER2_" + Parray.get(ibin) + "_" + Parray.get(ibin + 1), 400, 0., 400.));
			...
			h2_ThetaPhiAllGEN_vsP.add(
					new H2F("h2_ThetaPhiAllGEN_" + ibin, "h2_ThetaPhiAllGEN_" + Parray.get(ibin) + "_" + Parray.get(ibin + 1), 100, -180., 180., 100, 0, 60.));
			h2_ThetaPhiAllREC_vsP.add(
					new H2F("h2_ThetaPhiAllREC_" + ibin, "h2_ThetaPhiAllREC_" + Parray.get(ibin) + "_" + Parray.get(ibin + 1), 100, -180., 180., 100, 0, 60.));
			h2_ThetaPhiAllTRIGGER_vsP.add(new H2F("h2_ThetaPhiAllTRIGGER_" + ibin, "h2_ThetaPhiAllTRIGGER_" + Parray.get(ibin) + "_" + Parray.get(ibin + 1),
					100, -180., 180., 100, 0, 60.));
			h2_ThetaPhiAllTRIGGER2_vsP.add(new H2F("h2_ThetaPhiAllTRIGGER2_" + ibin, "h2_ThetaPhiAllTRIGGER2_" + Parray.get(ibin) + "_" + Parray.get(ibin + 1),
					100, -180., 180., 100, 0, 60.));
			...
			h2_ThetaPhiQPGEN_vsP.add(
					new H2F("h2_ThetaPhiQPGEN_" + ibin, "h2_ThetaPhiQPGEN_" + Parray.get(ibin) + "_" + Parray.get(ibin + 1), 100, -180., 180., 100, 0, 60.));
			h2_ThetaPhiQPREC_vsP.add(
					new H2F("h2_ThetaPhiQPREC_" + ibin, "h2_ThetaPhiQPREC_" + Parray.get(ibin) + "_" + Parray.get(ibin + 1), 100, -180., 180., 100, 0, 60.));
			h2_ThetaPhiQPTRIGGER_vsP.add(new H2F("h2_ThetaPhiQPTRIGGER_" + ibin, "h2_ThetaPhiQPTRIGGER_" + Parray.get(ibin) + "_" + Parray.get(ibin + 1), 100,
					-180., 180., 100, 0, 60.));
			h2_ThetaPhiQPTRIGGER2_vsP.add(new H2F("h2_ThetaPhiQPTRIGGER2_" + ibin, "h2_ThetaPhiQPTRIGGER2_" + Parray.get(ibin) + "_" + Parray.get(ibin + 1),
					100, -180., 180., 100, 0, 60.));
			...
			h2_ThetaPhiQMGEN_vsP.add(
					new H2F("h2_ThetaPhiQMGEN_" + ibin, "h2_ThetaPhiQMGEN_" + Parray.get(ibin) + "_" + Parray.get(ibin + 1), 100, -180., 180., 100, 0, 60.));
			h2_ThetaPhiQMREC_vsP.add(
					new H2F("h2_ThetaPhiQMREC_" + ibin, "h2_ThetaPhiQMREC_" + Parray.get(ibin) + "_" + Parray.get(ibin + 1), 100, -180., 180., 100, 0, 60.));
			h2_ThetaPhiQMTRIGGER_vsP.add(new H2F("h2_ThetaPhiQMTRIGGER_" + ibin, "h2_ThetaPhiQMTRIGGER_" + Parray.get(ibin) + "_" + Parray.get(ibin + 1), 100,
					-180., 180., 100, 0, 60.));
			h2_ThetaPhiQMTRIGGER2_vsP.add(new H2F("h2_ThetaPhiQMTRIGGER2_" + ibin, "h2_ThetaPhiQMTRIGGER2_" + Parray.get(ibin) + "_" + Parray.get(ibin + 1),
					100, -180., 180., 100, 0, 60.));
